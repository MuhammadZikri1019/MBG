...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['foto_profil']) && $_FILES['foto_profil']['error'] == 0) {
        ...
        if (in_array($ext, $allowed)) {
            $new_filename = "profil_karyawan_" . $id_karyawan . "_" . time() . "." . $ext;
    ...
    if (!$error) {
        ...
        $query_update = "UPDATE tbl_karyawan SET " . implode(', ', $updates) . " WHERE id_karyawan = '$id_karyawan'";
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?= ucfirst($user['bagian']) ?>" disabled readonly>
                            </div>
